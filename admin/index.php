        ...
        <div class="container dashboard__container manage_user">
            ...
            <main>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="tableBody">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat, obcaecati.</td>
                            <td>Wild Life</td>
                            <td><a href="edit-category.php">Edit</a></td>
                            <td><a href="delete-category.php" class="danger">Delete</a></td>
                        </tr>
                        <tr>
                            <td>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat, obcaecati.</td>
                            <td>Wild Life</td>
                            <td><a href="edit-category.php">Edit</a></td>
                            <td><a href="delete-category.php" class="danger">Delete</a></td>
                        </tr>
